const dataWithAnswers = [
  ...
  // id: 3219,
  {
    ...
    question:
      "Which of the following groups was not a common target for nativists in the 1800's?",
    options: [
      {
        id: "A",
        answer: "Protestants",
  ...
  // id: 5889,
  {
    ...
    image:
      "https://cross-platform-rwa.rp.devfactory.com/images/5889%20-%20Mexican-American%20War.png",
    question:
    ...
    options: [
      ...
      },
      {
        id: "B",
        answer:
          "A massive imbalance in tax revenue from existing states and new territories",
      },
      {
        id: "C",
        answer: "Disagreements over the 36°30′ line",
      },
    ],
    user: {
      name: "AP US History",
